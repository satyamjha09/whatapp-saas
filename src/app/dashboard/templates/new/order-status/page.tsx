...
import OrderStatusTemplateForm from "./order-status-template-form";

type SearchParams = Record<string, string | string[] | undefined>;

type NewOrderStatusTemplatePageProps = {
...
export default async function NewOrderStatusTemplatePage({
  searchParams,
}: NewOrderStatusTemplatePageProps) {
      ...
      <div className="mb-7 flex flex-wrap items-center justify-between gap-4">
        <div>
          ...
          <p className="mt-1 max-w-2xl text-sm leading-6 text-[#526173]">
            Build reusable Utility templates for order updates. Store mapping
            rules only; live order values are resolved later at send time.
          </p>
        </div>
