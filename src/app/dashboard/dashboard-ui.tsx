  ...
  return (
    <section className="mb-5 overflow-hidden rounded-2xl border border-[#D8E6F3] bg-white p-5 shadow-[0_16px_40px_rgba(8,27,58,0.08)] sm:p-6">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        <div>
          <p className="text-xs font-semibold uppercase tracking-normal text-[#2070B0]">
            {eyebrow}
          </p>
...
export function Panel({
  ...
  return (
    <section
      className={[
        "rounded-2xl border border-[#D8E6F3] bg-white p-5 shadow-[0_16px_40px_rgba(8,27,58,0.08)] sm:p-6",
        className,
      ].join(" ")}
    >
      {children}
...
export function MetricCard({
  ...
  return (
    <div className="rounded-2xl border border-[#D8E6F3] bg-white p-5 shadow-[0_14px_34px_rgba(8,27,58,0.07)]">
      <div className="grid h-11 w-11 place-items-center rounded-xl bg-[#F0F8FF] text-[#0052CC]">
...
export function EmptyState({ children }: { children: React.ReactNode }) {
  return (
    <div className="rounded-2xl border border-dashed border-[#D8E6F3] bg-[#F0F8FF] p-5 text-sm leading-6 text-[#526173]">
      {children}
    </div>
  );
}
...
export function actionButtonClass(variant: "primary" | "secondary" = "primary") {
  if (variant === "secondary") {
    return "inline-flex items-center justify-center rounded-xl border border-[#D8E6F3] bg-white px-4 py-2.5 text-sm font-semibold text-[#0052CC] transition hover:border-[#0052CC]/30 hover:bg-[#F0F8FF]";
  }

  return "inline-flex items-center justify-center rounded-xl bg-[#0052CC] px-4 py-2.5 text-sm font-semibold text-white shadow-[0_12px_26px_rgba(0,82,204,0.22)] transition hover:bg-[#003F9E] disabled:cursor-not-allowed disabled:opacity-60";
}

export const fieldClass =
  "w-full rounded-xl border border-[#D8E6F3] bg-white px-4 py-3 text-sm text-[#102040] outline-none transition placeholder:text-[#526173]/60 focus:border-[#0052CC]/40 focus:ring-4 focus:ring-[#0052CC]/10";
