...
export default function InboxLoading() {
  return (
    <div className="flex h-[calc(100vh-6rem)] max-h-screen min-h-0 flex-col overflow-hidden rounded-2xl border border-[#D8E6F3] bg-[linear-gradient(135deg,#FFFFFF,#F0F8FF_54%,rgba(216,230,243,0.72))] p-4 shadow-[0_18px_48px_rgba(8,27,58,0.10)]">
      <div className="flex shrink-0 items-center justify-between gap-4 border-b border-[#D8E6F3] pb-3">
