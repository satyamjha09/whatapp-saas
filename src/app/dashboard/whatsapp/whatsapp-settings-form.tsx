...
const fieldClass =
  "w-full rounded-xl border border-[#D8E6F3] bg-white px-4 py-3 text-sm text-[#102040] outline-none transition placeholder:text-[#526173]/60 focus:border-[#0052CC]/40 focus:ring-4 focus:ring-[#0052CC]/10 disabled:cursor-not-allowed disabled:bg-[#F0F8FF] disabled:text-[#526173]";
...
export default function WhatsAppSettingsForm({
  ...
  return (
    <form onSubmit={saveSettings} className="space-y-5">
      <div className="rounded-2xl border border-[#D8E6F3] bg-[#F0F8FF] p-4">
        <div className="flex items-start gap-3">
          <div className="grid h-10 w-10 shrink-0 place-items-center rounded-xl bg-white text-[#0052CC]">
      ...
      <div className="flex flex-wrap gap-3">
        ...
        <button
          ...
          className="inline-flex items-center justify-center gap-2 rounded-xl border border-[#D8E6F3] bg-white px-4 py-2.5 text-sm font-semibold text-[#0052CC] transition hover:bg-[#F0F8FF] disabled:cursor-not-allowed disabled:opacity-60"
        >
