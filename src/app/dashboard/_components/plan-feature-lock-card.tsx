...
export default function PlanFeatureLockCard({
  ...
  return (
    <section className="rounded-2xl border border-[#D8E6F3] bg-white p-6 text-center shadow-[0_16px_40px_rgba(8,27,58,0.08)] sm:p-8">
      <div className="mx-auto flex h-11 w-11 items-center justify-center rounded-xl bg-[#F0F8FF] text-[#0052CC]">
      ...
      <p className="mt-3 text-xs font-semibold text-[#2070B0]">
