...
import { createAutomationFlowDraft } from "@/server/services/automation-versioning.service";
import { getCompanyTrustAcceptanceStatus } from "@/server/services/trust-center.service";

export default async function NewAutomationBuilderPage() {
  ...
  const flow = await createAutomationFlowDraft({
