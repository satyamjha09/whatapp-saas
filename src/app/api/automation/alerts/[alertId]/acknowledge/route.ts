...
import { acknowledgeAlert } from "@/server/services/automation-alert.service";
import {
...
export async function POST(_request: Request, { params }: RouteContext) {
  try {
    ...
    console.error("AUTOMATION_ALERT_ACKNOWLEDGE_ERROR:", error);
    return NextResponse.json({ message: "Unable to acknowledge alert" }, { status: 500 });
  }
}
