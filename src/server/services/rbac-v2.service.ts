...
export const SYSTEM_ROLE_PERMISSIONS: Record<string, RbacPermission[]> = {
  ...
  admin: permissions(
    ...
    "INBOX_BULK_ACTION", "INBOX_USE_AI", "INBOX_MANAGE_QUEUES", "INBOX_MANAGE_AGENTS",
  ...
  manager: permissions(
    "DASHBOARD_VIEW", "INBOX_VIEW", "INBOX_REPLY", "INBOX_ASSIGN", "INBOX_CLOSE",
    "INBOX_USE_AI", "INBOX_MANAGE_QUEUES",
  ...
  member: permissions(
    "DASHBOARD_VIEW", "INBOX_VIEW", "INBOX_REPLY", "INBOX_USE_AI", "CONTACT_VIEW", "CAMPAIGN_VIEW",
    "TEMPLATE_VIEW",
    ...AUTOMATION_MANAGER_PERMISSIONS,
  ),
